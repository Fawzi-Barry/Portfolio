...
import { FaHome, FaDownload, FaGoogleDrive } from "react-icons/fa";
  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-between px-3 md:px-24 py-3">
        <div>
          <Link to="/">
            <h1 className="text-2xl text-primary font-lobster">Fawzi Barry</h1>
          </Link>
        </div>
        <div>
            ...
            >
              ...
              <div className="text-center">
                <p className="text-neutral">
                  &copy; Copyright 2025, Fawzi Barry. All Rights Reserved
                </p>
              </div>
            </Drawer>
          </div>
